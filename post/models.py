...
class Categories(models.Model):
    ...
    name = models.CharField(
        max_length=50, choices=Category_Choices.choices, default=Category_Choices.BİLİNMEYENLER)
    color = models.CharField(
        max_length=30, choices=Color_Choices.choices, default=Color_Choices.RED)
